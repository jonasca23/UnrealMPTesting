...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_MultiplayerSessions_MultiplayerOnCreateSessionComplete__DelegateSignature_Statics::Function_MetaDataParams[] = {
		...
		{ "ToolTip", "Declaring our own custom delegates for the Menu Class bind it's callbacks to\n\n\nDYNAMIC means that this delegate can be serialized and can be used through blueprints (called event dispatchers)\nMULTICAST means that multiple classes can bind their functions to this delegate" },
	};
#endif
	...
	struct Z_CompiledInDeferFile_FID_UnrealMPTesting_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_MultiplayerSessionsSubsystem_h_Statics
	{
